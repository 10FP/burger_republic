...
function populateItems(items) {
	...
	for (i = 0; i < items.length; i++) {
		...
		if (items[i].type === "food") {
            ...
            imgElement.src = "https://images.unsplash.com/photo-1602192103201-d763907bc41b?q=80&w=1740&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
